    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def forward(
        ...
        Args:
            ...
            need_self_attn_weights (bool, optional): return last layer self attention weights
        ...
        x, attn = self.self_attn(
            ...
            need_weights=need_self_attn_weights,  # here we modify the default false to optional parameter, add by .,.
            attn_mask=self_attn_mask,
        )
        # here we record the self attention weights, if not need_self_attn_weights, the value is none
        if attn is not None:
            # print(attn.size())
            self_attn_weights = attn.clone()
        else:
        ...
        if self.onnx_trace and incremental_state is not None:
            ...
            if need_self_attn_weights:
                return x, attn, self_attn_state, self_attn_weights
            else:
                return x, attn, self_attn_state, None

        if need_self_attn_weights:
            return x, attn, None, self_attn_weights
        else:
